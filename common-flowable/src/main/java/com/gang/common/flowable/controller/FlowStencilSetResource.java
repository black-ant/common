...
public class FlowStencilSetResource {
    ...
    public JsonNode getStencilSetForEditor() {
        try {
            JsonNode stencilNode = objectMapper.readTree(this.getClass().getClassLoader().getResourceAsStream(
                    "stencilset/zh/stencilset_bpmn.json"));
            return stencilNode;
        } catch (Exception e) {
    ...
    public JsonNode getCmmnStencilSetForEditor() {
        try {
            JsonNode stencilNode = objectMapper.readTree(this.getClass().getClassLoader().getResourceAsStream(
                    "stencilset/zh/stencilset_cmmn.json"));
            return stencilNode;
        } catch (Exception e) {
            logger.error("Error reading bpmn stencil set json", e);
            throw new InternalServerErrorException("Error reading bpmn stencil set json");
