...
import com.gang.common.exception.ScheduleException;
...
/**
 * @Classname quzartService
 * @Description TODO
 * @Date 2020/4/28 20:30
 * @Created by zengzg
 */
@Component
public class QuzartService {
    ...
    public Boolean addTask(TaskEntity info) {
        ...
        try {
            ...
            throw new ScheduleException("Schedule Exception : " + e.getMessage());
        }
    }
